...
#ifndef TABATAPP_SWIFT_H
#define TABATAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="tabatapp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8tabatapp11AppDelegate")
...
SWIFT_CLASS("_TtC8tabatapp17MainFlutterWindow")
